...
{
    var pathtojsfiles = "/media/js/jqGrid/js/"; // need to be ajusted
...
/*        { include: true, incfile:'grid.pack.js',minfile: ''},  */ // jqGrid all packecd
        ...
        { include: true, incfile:'grid.setcolumns.js',minfile: '/media/js/jqGrid/js/min/grid.setcolumns-min.js'} //jqGrid setcolumns
    ];
    var filename;
